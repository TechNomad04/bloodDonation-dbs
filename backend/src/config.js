...
// Support either MONGO_URL or MONGO_URI so .env with MONGO_URI works
export const MONGO_URL = process.env.MONGO_URL || process.env.MONGO_URI || 'mongodb+srv://agarwalsamiksha88_db_user:HI123@cluster0.apgknf5.mongodb.net/?appName=Cluster0'
